...
import SwearJar from "./myswearjar.js";
import fs from "fs";
...
function loadWordsFromDictionaryObject(
  dictionary,
  shouldAppendWords,
  shouldAppendCategoriesForWords
) {
...
function setUseWholeWordMatch(useWholeWordMatch) {
  this.sj.setUseWholeWordMatch(useWholeWordMatch);
}

function getUseWholeWordMatch() {
  return this.sj.getUseWholeWordMatch();
}

const Profane = function () {
...
Profane.prototype = {
  ...
  setUseWholeWordMatch: setUseWholeWordMatch,
  getUseWholeWordMatch: getUseWholeWordMatch,
};

export default Profane;
